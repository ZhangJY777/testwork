    ...
    function appendBanner() {
        ...
        $(".body").prepend('\
          <div class= "item-purchase-banner">\
            <p class="banner-text">本平台严格遵守各国法律法规，坚决打击跨境违法交易，全力维护安全合规的跨境贸易环境。            </p>\
              <a href="http://www.customs.gov.cn/" target="_blank" class= "banner-button btn btn-primary btn-icon">\
                <i class="mdi mdi-access-point"></i> 海关总署\
              </a>\
